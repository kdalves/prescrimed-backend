...
routes.get('/usuarios/:id', UserController.update);
...
routes.get('/profissionais/:id', ProfissionalController.update);
...
routes.get('/protocolos/:id', ProtocolController.update);
...
routes.get('/pacientes/:id', PatientController.update);
...
routes.get('/prescricao/:id', PrescriptionController.update);
